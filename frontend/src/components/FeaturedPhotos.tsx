    ...
    <section className="mx-auto max-w-7xl px-4 pb-12 sm:px-6">
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-2">
          <Image className="h-4 w-4 text-spill-accent" />
          <h2 className="font-headline text-xl font-bold text-spill-text-primary">Featured Photos</h2>
          {total > 0 && (
      ...
      <p className="text-sm text-spill-text-secondary mb-6">Seized photographs flagged as containing nudity</p>
